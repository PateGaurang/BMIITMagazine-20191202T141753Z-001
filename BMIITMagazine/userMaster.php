...
<header>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-6 header-top-right no-padding">
                    <ul>
                         <?php
                        $query="select * from tbluser where contactNo=".$_SESSION["username"];
    ...
    if (isset($_POST["btnChangePassword"])) {
        ...
        $query = "select * from tbluser where contactNo=$contactNo and password=SHA1('$oldPassword')";
        $result = $con->query($query);
        if ($result->num_rows == 1) {
            $stmt = "update tbluser set password=SHA1(?) where contactNo=$contactNo";
        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-4 col-md-4 col-sm-12 logo-left no-padding">
                    <a href="studentHome.php"><h2 style="margin-top: 2%;"><span style="color: red ">BMIIT</span> <span style="color: #0000000;">CHRONICLES</span>  </h2></a>
                </div>
