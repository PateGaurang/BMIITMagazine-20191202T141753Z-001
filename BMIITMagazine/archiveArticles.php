...
<html lang="zxx" class="no-js">
    <head>
        ...
        <meta charset="UTF-8">
        <?php
        $query="select * from tblmagazineissues where id=".$_GET["id"];
        $result=$con->query($query);
        $row=$result->fetch_array();
        ?>
        <title><?php echo $row["title"]; ?> | Archive Articles</title>
                    ...
                    <div class="row">
                        <div class="col-lg-8 post-list">
                            <div class="latest-post-wrap">
                                ...
                                <?php
                                $id=$_GET["id"];
                                $query = "select * from tblarticles where magazineId=".$_GET["id"]." and isApproved=1 ORDER BY lastModification DESC";
                                $result = $con->query($query);
