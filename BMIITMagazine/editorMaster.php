        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-4 col-md-4 col-sm-12 logo-left no-padding">
                    <a href="editorHome.php"><h2 style="margin-top: 2%;"><span style="color: red ">BMIIT</span> <span style="color: #0000000;">CHRONICLES</span>  </h2></a>
                </div>
    ...
    <div class="container main-menu" id="main-menu">
        <div class="row align-items-center justify-content-between">
            <nav id="nav-menu-container">
                <ul class="nav-menu">
                    <li class="menu-active"><a href="editorHome.php">Home</a></li>
                    ...
                    <li><a href="#">Manage Unpublished</a>
                        <ul>
                            <li><a href="assignedArticle.php">ASSIGNED ARTICLES</a></li>
                            <li><a href="viewUnpublished.php">VIEW ALL UNPUBLISHED ARTICLE</a></li>
                        </ul>
                    </li>
