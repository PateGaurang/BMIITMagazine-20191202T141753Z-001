    ...
    if ($usertype == "Admin") {
        ...
        <html class="no-js" lang="en">
            ...
            <head>
                ...
                <title>Update Article Request</title>
                    ...
                    <div id="content">
                        <div class="container">
                            <center>
                                ...
                                <?php
                                $query = "select * from tblarticles where isApproved in(3,7)";
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_array()) {
                                        ...
                                        if ($row["editorId"] == "0") {
                                            echo "<td><form action='assignEditor.php?id=" . $row["id"] . "&type=1' method='post'>";
