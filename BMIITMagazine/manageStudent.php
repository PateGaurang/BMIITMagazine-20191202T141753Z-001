            ...
            <body>
                ...
                <script>
                    function confirmDelete(id) {
                        var temp = confirm("Do You want to block this student?");
                        if (temp) {
                            window.location = "toggleStudents.php?sid=" + id;
                        }
                    }
                    function confirmUnbloack(id) {
                        var temp = confirm("Do You want to unblock this student?");
                        if (temp) {
                            window.location = "toggleStudents.php?pid=" + id;
                        }
                    }
                </script>
            </body>
